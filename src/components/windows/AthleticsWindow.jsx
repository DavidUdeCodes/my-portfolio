const AthleticsWindow = () => (
  <div className="p-6 main-font max-w-[70vw]">
    <section className="flex flex-row items-center">
      <img className="w-80 border border-transparent rounded-[3rem]" src="images/meTracknationals.jpg" alt="Me Basketball"/>
      <div className="flex flex-col mt-4 p-4 ml-7"> 
        <h1 className="text-5xl font-medium mb-2 text-[#32323F]">Track and Field</h1>
    ...
    <section className="flex flex-row mt-10">
        <div className="flex flex-col mt-8 mr-4"> 
          <h1 className="text-5xl font-medium mb-2 text-[#32323F]">Basketball</h1>
        ...
        <img className="w-80 border border-transparent rounded-[3rem]" src="images/meProvincialbasketball.jpg" alt="Me Basketball"/>
    </section>
  </div>
);
